                  ...
                  <div>
                    ...
                    <div class="mt-4">
                      ...
                      <p class="mt-4 leading-relaxed text-gray-700">
                        First time taking Abis got me Overwhelming and since
                        then its been nice on the family aspect. Abis Cravings
                ...
                <blockquote class="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                  <div>
                    ...
                    <div class="mt-4">
                      ...
                      <p class="mt-4 leading-relaxed text-gray-700">
                        With Abis you have everything to keep you going, moving,
                        never stop , staying alive and healthy is a guarantee
                        and we have cherished it so far
                      </p>
                    </div>
                  </div>
                ...
                <blockquote class="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                  <div>
                    ...
                    <div class="mt-4">
                      ...
                      <p class="mt-4 leading-relaxed text-gray-700">
                        Life is purely good and yes it been one Overwhelming,
                        its a 100% for me with them. Highly recommend what is
                        good so you can do that and thank me later
                      </p>
                    </div>
                  </div>

                  <footer class="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
                    &mdash; Omobolarinwa Quadri
                  </footer>
                </blockquote>
              </div>
            </div>
